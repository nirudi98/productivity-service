...
@Service
public class PullRequestInfoHelper {
    private static final Logger logger = LoggerFactory.getLogger(PullRequestInfoHelper.class);
    ...
    public PRInformation formatPRResponse(PullRequestEntity pr, LocalDateTime endDate, LocalDateTime startDate) {
